...
/** @public
 *
 * This represents the interface of the event triggered from {@link Inbox.on__conversationSelected__ | Inbox.on("conversationSelected")}.
 */
...
/**
 * Sent by {@link Session.on__desktopNotificationClicked__ | Session.on("desktopNotificationClicked")} when a user clicks on a browser notification.
 *
 * @public
 */
...
export declare interface Inbox extends UIBox {
     ...
     * @namedoverload on("translationToggled")
     */
...
/**
 * @public
 * Event data triggered from {@link Inbox.on__selectConversation__ | Inbox.on("selectConversation")}.
 */
...
export declare class Session {
     ...
     *
     *  @namedoverload on("message")
     */
    on(eventType: "message", handler: (message: Message) => void): void;
    /**
     * Used to listen to notification clicks.
     *
     * @remarks
     ...
     *
     * @namedoverload on("desktopNotificationClicked")
     */
